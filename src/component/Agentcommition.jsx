...
const AgentCommission = () => {
  ...
  useEffect(() => {
    ...
    const tds = commission * 0.1;
    const netPayable = commission - tds;
          ...
          <tbody>
            {commissions.map((c) => (
              <tr key={c._id} className="border-b">
                ...
                <td className="p-3 text-right">₹{c.totalSales}</td>
                <td className="p-3 text-center">{c.rate}%</td>
                <td className="p-3 text-right">₹{c.commission}</td>
