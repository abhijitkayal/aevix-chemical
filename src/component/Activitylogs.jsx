...
const Activitylogs = () => {
  ...
  const activityLogs = [
    ...
    },
    {
      ...
      details:
        "Adjusted stock quantity for Titanium Dioxide Pigment from 450kg to 480kg",
    ...
    },
    {
      ...
      details:
        "Low stock alert generated for Caustic Soda Pellets - Current: 580kg, Required: 600kg",
      ipAddress: "INTERNAL",
      status: "Warning",
      type: "System Event",
    },
    {
      ...
      details:
        "Stock transfer from Main Warehouse to Production Unit - 200L Sulfuric Acid",
    ...
    },
    {
      ...
      details:
        "Generated invoice for customer ChemTrade Solutions - Amount: ₹285,000",
    ...
    },
    {
      ...
      details:
        'Updated lead status from "Contacted" to "Negotiation" for Industrial Polymers Ltd',
    ...
    },
    {
      ...
      details:
        "Updated variance report for Batch PRD-B-2026-006 - Status: Unfavorable",
    ...
    },
    {
      ...
      details:
        "Created quotation for PharmaChem Industries - 1000L Ethanol 95%",
    ...
    },
    {
      ...
      details:
        "Auto-scheduled production plan for next week based on demand forecast",
      ipAddress: "INTERNAL",
      status: "Success",
      type: "System Event",
    },
    {
      ...
      details:
        "Updated work order progress from 50% to 60% for Hydrochloric Acid production",
    ...
    },
    {
      ...
      entityId: "USR029",
      details:
        "Created new user account for Ravi Shankar - Role: Production Operator",
    ...
    },
    {
      ...
      entityId: "DASH-SALES",
      details:
        "Accessed sales analytics dashboard and generated monthly report",
    ...
    },
    {
      ...
      entityId: "ROLE008",
      details:
        'Modified permissions for Sales Manager role - Added "Export Reports"',
    ...
    },
    {
      ...
      details:
        "Work order completion alert - WO-2025-098 completed on schedule",
      ipAddress: "INTERNAL",
      status: "Success",
      type: "System Event",
    },
    ...
    },
    {
      ...
      details:
        "Updated customer ledger for TechChem Solutions - Payment received: ₹150,000",
    ...
    },
    {
      ...
      details:
        "Stock adjustment for Hydrogen Peroxide 35% - Damaged stock written off: 20L",
    ...
    },
    {
      ...
      details:
        "Failed to send email notification to customer - Retry scheduled",
      ipAddress: "INTERNAL",
      status: "Error",
      type: "System Event",
    },
    {
      ...
      details:
        "Created variance report for Batch PRD-B-2026-007 - Material variance: -₹5,200",
    ...
    },
    {
      ...
      details:
        "Created purchase order for Ilmenite Ore - Quantity: 1500kg, Supplier: Mineral Traders",
    ...
    },
    {
      ...
      details:
        "Updated job work status - Repackaging 40% completed at PackMaster Solutions",
    ...
    },
    {
      ...
      entityId: "WH-MAIN",
      details:
        "Accessed Main Warehouse inventory report - Current utilization: 85%",
    ...
    },
    {
      ...
      details:
        "System cache cleared automatically - Performance optimization completed",
      ipAddress: "INTERNAL",
      status: "Success",
      type: "System Event",
    },
    {
      ...
      details:
        "Updated system configuration - Modified email notification settings",
    ...
    },
    {
      ...
      details:
        "Scheduled production for Ammonia Solution 25% - Start: 2026-01-09",
    ...
    },
    {
      ...
      details:
        "Generated and viewed monthly financial report for December 2025",
    ...
    },
    {
      ...
      details:
        "Approved variance report for Batch PRD-B-2026-005 - Quality check passed",
    ...
    },
    {
      ...
      details:
        "Created purchase order for Iron Oxide - Quantity: 280kg, Supplier: Oxide Materials",
    ...
    },
    {
      ...
      details:
        "Material availability alert - Ilmenite ore pending for Work Order WO-2026-003",
      ipAddress: "INTERNAL",
      status: "Warning",
      type: "System Event",
    },
    {
      ...
      entityId: "BOM012",
      details:
        "Updated Bill of Materials for Ethanol 95% - Modified denaturant quantity",
      ipAddress: "192.168.1.101",
      status: "Success",
      type: "User Action",
    },
    ...
    },
    {
      ...
      details:
        "Physical stock verification - Adjusted Acetic Acid 99% quantity +10L",
      ipAddress: "192.168.1.112",
      status: "Success",
      type: "User Action",
    },
    {
      ...
      details:
        "Hourly data synchronization completed - All modules synchronized",
      ipAddress: "INTERNAL",
      status: "Success",
      type: "System Event",
    },
    {
      ...
      details:
        "Updated invoice payment status - Partial payment received: ₹100,000",
      ipAddress: "192.168.1.108",
      status: "Success",
      type: "User Action",
    },
    {
      ...
      details:
        "Added new lead - Company: BioTech Research Ltd, Contact: Dr. Sharma",
      ipAddress: "192.168.1.115",
      status: "Success",
      type: "User Action",
    },
    ...
    },
    {
      ...
      entityId: "WH-PROD",
      details:
        "Updated Production Warehouse layout - Reorganized storage sections",
      ipAddress: "192.168.1.118",
      status: "Success",
      type: "User Action",
    },
    {
      ...
      details:
        "Daily usage report generated - Active users: 18, Total sessions: 42",
      ipAddress: "INTERNAL",
      status: "Success",
      type: "System Event",
    },
    ...
    },
    {
      ...
      details:
        "Checked job work status for Granulation process at ChemProcess Industries",
      ipAddress: "192.168.1.125",
      status: "Success",
      type: "User Action",
    },
  ...
  return (
    <div className="p-6 min-h-screen mt-10 mt">
      {/* Header */}
      <div className="mb-6">
