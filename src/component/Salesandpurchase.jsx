    ...
    const fetchData = async () => {
      try {
        const [
          ...
          axios.get('https://aevix-chem-backend-bksy.onrender.com/api/invoices'), // SALE
          axios.get('https://aevix-chem-backend-bksy.onrender.com/api/purchase-invoices'), // PURCHASE
        ]);
