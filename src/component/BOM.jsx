  ...
  const bomData = [
    ...
    },
    {
      ...
      components: [
        ...
        {
          code: "PKG-DRM-001",
          name: "Acid Resistant Drum 50L",
          quantity: 40,
          unit: "Pcs",
          rate: 800,
          amount: 32000,
          supplier: "DrumTech Ltd",
        },
        {
          code: "PKG-LBL-002",
          name: "Hazard Label Large",
          quantity: 40,
          unit: "Pcs",
          rate: 20,
          amount: 800,
    ...
    },
    {
      ...
      components: [
        ...
        {
          code: "PKG-BAG-001",
          name: "Multi-layer Paper Bag 25Kg",
          quantity: 40,
          unit: "Pcs",
          rate: 125,
          amount: 5000,
          supplier: "PackSafe Corp",
        },
        {
          code: "PKG-LNR-001",
          name: "Plastic Liner",
      ...
      components: [
        {
          ...
          rate: 120,
          amount: 96000,
          supplier: "Methanol Corp",
        },
        {
          code: "RAW-COCAT-001",
          name: "Cobalt Catalyst",
          quantity: 5,
          unit: "Kg",
          rate: 8000,
          amount: 40000,
        ...
        {
          code: "PKG-DRM-002",
          name: "Stainless Steel Drum 200L",
          quantity: 8,
          unit: "Pcs",
          rate: 7000,
          amount: 56000,
    ...
    },
    {
      ...
      components: [
        {
          code: "RAW-H2O2C-001",
          name: "H2O2 Concentrate 70%",
          quantity: 600,
          unit: "Liter",
          rate: 250,
          amount: 150000,
          supplier: "Peroxide Corp",
        },
        {
          code: "RAW-H2O-001",
          name: "Deionized Water",
    ...
    },
    {
      ...
      components: [
        ...
        {
          code: "PKG-BAG-003",
          name: "Breathable Tyvek Pouch 1Kg",
          quantity: 500,
          unit: "Pcs",
          rate: 75,
          amount: 37500,
      ...
      components: [
        {
          ...
          rate: 450,
          amount: 3060,
          supplier: "Fine Chemicals Ltd",
        },
        {
          code: "RAW-NA2HPO4-001",
      ...
      components: [
        {
          ...
          rate: 100,
          amount: 190000,
          supplier: "Ethanol Distillers",
        },
        {
          code: "RAW-METH-002",
          name: "Methanol (Denaturant)",
          quantity: 100,
          unit: "Liter",
          rate: 120,
          amount: 12000,
    ...
    <div className="p-6 min-h-screen mt-10">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Manage product compositions and component requirements
        </p>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
        <div className="px-4 md:px-6 py-4 bg-gray-100 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-black">
            Bill of Materials List
          </h2>
          <p className="text-sm text-gray-600 mt-1">
            Click on any product to view detailed component breakdown
          </p>
        </div>
        ...
        <div className="divide-y divide-gray-200">
          {filteredBOM.map((bom) => (
            <div key={bom.id} className="bg-white">
              {/* PRODUCT HEADER */}
              <div
                className="px-4 md:px-6 py-4 cursor-pointer hover:bg-gray-100 transition-colors"
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  ...
                  <div className="flex items-start md:items-center gap-3">
                    {expandedProduct === bom.id ? (
                      <ChevronDown
                        className="text-gray-500 mt-1 md:mt-0"
                        size={20}
                      />
                    ) : (
                      <ChevronRight
              ...
              {/* COMPONENT DETAILS */}
              {expandedProduct === bom.id && (
                <div className="px-4 md:px-6 py-4 bg-gray-100 border-t border-gray-200">
                  <h4 className="font-semibold text-black mb-3">
                    Component Breakdown
                  </h4>

                  <div className="overflow-x-auto">
                    <table className="min-w-225 w-full divide-y divide-gray-200 bg-white">
