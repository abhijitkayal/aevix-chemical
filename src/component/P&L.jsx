  ...
  const plData = {
    ...
    revenue: {
      ...
      breakdown: [
        ...
        { category: "Pharmaceutical Grade", amount: 1100000, percentage: 18.8 },
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-1">
            Comprehensive income statement showing revenue, expenses, and
            profitability
          </p>
        </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600">
                  ₹{(plData.revenue.totalRevenue / 100000).toFixed(2)}L
                </p>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">
                  ₹{(plData.grossProfit / 100000).toFixed(2)}L
                </p>
                <p className="text-xs text-gray-600 mt-1">
                  {plData.grossProfitMargin.toFixed(2)}% margin
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-yellow-600">
                  ₹{(plData.operatingProfit / 100000).toFixed(2)}L
                </p>
                <p className="text-xs text-gray-600 mt-1">
                  {plData.operatingMargin.toFixed(2)}% margin
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-700">
                  ₹{(plData.netProfit / 100000).toFixed(2)}L
                </p>
          ...
          <div className="p-6">
            <div className="border-b pb-4 mb-4">
              <h2 className="text-2xl font-bold text-gray-800">
                Aevix Chemical Pvt. Ltd.
              </h2>
              <p className="text-gray-600">Profit & Loss Statement</p>
              <p className="text-sm text-gray-500">
                For the period: {plData.startDate} to {plData.endDate}
              </p>
            </div>
                ...
                <div className="pl-6 mt-2">
                  <div className="flex justify-between py-2 border-b">
                    ...
                    <span className="font-semibold">
                      ₹{plData.revenue.salesRevenue.toLocaleString("en-IN")}
                    </span>
                    {showComparison && (
                      <span className="text-xs text-gray-500 w-24 text-right">
                        Dec: ₹{(5485000).toLocaleString("en-IN")}
                      </span>
                    )}
                  </div>
                  ...
                  {plData.revenue.breakdown.map((item, index) => (
                    <div
                      key={index}
                      className="flex justify-between py-1 pl-6 text-sm"
                    >
                  ...
                  <div className="flex justify-between py-2 border-b">
                    ...
                    <span className="font-semibold">
                      ₹{plData.revenue.otherIncome.toLocaleString("en-IN")}
                    </span>
                    {showComparison && (
                      <span className="text-xs text-gray-500 w-24 text-right">
                        Dec: ₹{(195000).toLocaleString("en-IN")}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="flex justify-between py-3 bg-blue-100 px-3 rounded font-bold text-blue-900">
                    ...
                    <span>
                      ₹{plData.revenue.totalRevenue.toLocaleString("en-IN")}
                    </span>
                    {showComparison && (
                      <span className="text-sm w-24 text-right">
                        ₹
                        {compareData.revenue.totalRevenue.toLocaleString(
                          "en-IN",
                        )}
                      </span>
                    )}
                ...
                <div className="pl-6 mt-2">
                  <div className="flex justify-between py-2 border-b">
                    ...
                    <span className="font-semibold text-red-700">
                      ₹{plData.cogs.rawMaterials.toLocaleString("en-IN")}
                    </span>
                  </div>
                  <div className="flex justify-between py-2 border-b">
                    <span className="text-gray-700">Direct Labor</span>
                    <span className="font-semibold text-red-700">
                      ₹{plData.cogs.directLabor.toLocaleString("en-IN")}
                    </span>
                  </div>
                  <div className="flex justify-between py-2 border-b">
                    <span className="text-gray-700">
                    ...
                    <span className="font-semibold text-red-700">
                      ₹
                      {plData.cogs.manufacturingOverhead.toLocaleString(
                        "en-IN",
                      )}
                    </span>
                  </div>
                  <div className="flex justify-between py-2 border-b">
                    ...
                    <span className="font-semibold text-red-700">
                      ₹{plData.cogs.freight.toLocaleString("en-IN")}
                    </span>
                  </div>
                  <div className="flex justify-between py-2 border-b">
                    <span className="text-gray-700">Packaging Material</span>
                    <span className="font-semibold text-red-700">
                      ₹{plData.cogs.packagingMaterial.toLocaleString("en-IN")}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between py-3 bg-red-100 px-3 rounded font-bold text-red-900">
                    ...
                    <span>
                      ₹{plData.cogs.totalCOGS.toLocaleString("en-IN")}
                    </span>
                    {showComparison && (
                      <span className="text-sm w-24 text-right">
                        ₹{compareData.cogs.totalCOGS.toLocaleString("en-IN")}
                      </span>
                    )}
                  </div>
                </div>
            ...
            <div className="flex justify-between py-4 bg-green-50 px-4 rounded font-bold text-lg text-green-900 mb-6">
              ...
              <div className="flex gap-8">
                <span>
                  ...
                  {plData.grossProfitMargin.toFixed(2)}%)
                </span>
                {showComparison && (
                  <span className="text-sm">
                    ₹{compareData.grossProfit.toLocaleString("en-IN")} (
                    {(
                      (compareData.grossProfit /
                        compareData.revenue.totalRevenue) *
                      100
                    ).toFixed(2)}
                    %)
                  </span>
                ...
                <div className="pl-6 mt-2">
                  <div className="flex justify-between py-2 border-b">
                    ...
                    <span className="font-semibold text-orange-700">
                      ₹
                      {plData.operatingExpenses.salariesWages.toLocaleString(
                        "en-IN",
                      )}
                    </span>
                  </div>
                  <div className="flex justify-between py-2 border-b">
                    ...
                    <span className="font-semibold text-orange-700">
                      ₹
                      {plData.operatingExpenses.rentUtilities.toLocaleString(
                        "en-IN",
                      )}
                    </span>
                  </div>
                  <div className="flex justify-between py-2 border-b">
                    ...
                    <span className="font-semibold text-orange-700">
                      ₹
                      {plData.operatingExpenses.depreciation.toLocaleString(
                        "en-IN",
                      )}
                    </span>
                  </div>
                  <div className="flex justify-between py-2 border-b">
                    ...
                    <span className="font-semibold text-orange-700">
                      ₹
                      {plData.operatingExpenses.marketing.toLocaleString(
                        "en-IN",
                      )}
                    </span>
                  </div>
                  <div className="flex justify-between py-2 border-b">
                    ...
                    <span className="font-semibold text-orange-700">
                      ₹
                      {plData.operatingExpenses.adminExpenses.toLocaleString(
                        "en-IN",
                      )}
                    </span>
                  </div>
                  <div className="flex justify-between py-2 border-b">
                    ...
                    <span className="font-semibold text-orange-700">
                      ₹
                      {plData.operatingExpenses.transportationLogistics.toLocaleString(
                        "en-IN",
                      )}
                    </span>
                  </div>
                  <div className="flex justify-between py-2 border-b">
                    ...
                    <span className="font-semibold text-orange-700">
                      ₹
                      {plData.operatingExpenses.insurance.toLocaleString(
                        "en-IN",
                      )}
                    </span>
                  </div>
                  <div className="flex justify-between py-2 border-b">
                    ...
                    <span className="font-semibold text-orange-700">
                      ₹
                      {plData.operatingExpenses.maintenance.toLocaleString(
                        "en-IN",
                      )}
                    </span>
                  </div>
                  <div className="flex justify-between py-2 border-b">
                    ...
                    <span className="font-semibold text-orange-700">
                      ₹
                      {plData.operatingExpenses.communication.toLocaleString(
                        "en-IN",
                      )}
                    </span>
                  </div>
                  <div className="flex justify-between py-2 border-b">
                    ...
                    <span className="font-semibold text-orange-700">
                      ₹
                      {plData.operatingExpenses.professionalFees.toLocaleString(
                        "en-IN",
                      )}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between py-3 bg-orange-100 px-3 rounded font-bold text-orange-900">
                    ...
                    <span>
                      ₹
                      {plData.operatingExpenses.totalOpex.toLocaleString(
                        "en-IN",
                      )}
                    </span>
                    {showComparison && (
                      <span className="text-sm w-24 text-right">
                        ₹
                        {compareData.operatingExpenses.totalOpex.toLocaleString(
                          "en-IN",
                        )}
                      </span>
                    )}
            ...
            <div className="flex justify-between py-4 bg-yellow-50 px-4 rounded font-bold text-lg text-yellow-900 mb-6">
              ...
              <div className="flex gap-8">
                <span>
                  ₹{plData.operatingProfit.toLocaleString("en-IN")} (
                  {plData.operatingMargin.toFixed(2)}%)
                </span>
                {showComparison && (
                  <span className="text-sm">
                    ₹{compareData.operatingProfit.toLocaleString("en-IN")} (
                    {(
                      (compareData.operatingProfit /
                        compareData.revenue.totalRevenue) *
                      100
                    ).toFixed(2)}
                    %)
                ...
                <div className="pl-6 mt-2">
                  <div className="flex justify-between py-2 border-b">
                    ...
                    <span className="font-semibold text-green-700">
                      ₹
                      {plData.otherIncomeExpense.interestIncome.toLocaleString(
                        "en-IN",
                      )}
                    </span>
                  </div>
                  <div className="flex justify-between py-2 border-b">
                    ...
                    <span className="font-semibold text-red-700">
                      (₹
                      {Math.abs(
                        plData.otherIncomeExpense.interestExpense,
                  ...
                  <div className="flex justify-between py-2 border-b">
                    ...
                    <span className="font-semibold text-green-700">
                      ₹
                      {plData.otherIncomeExpense.foreignExchangeGain.toLocaleString(
                        "en-IN",
                      )}
                    </span>
                  </div>
                  <div className="flex justify-between py-2 border-b">
                    ...
                    <span className="font-semibold text-red-700">
                      (₹
                      {Math.abs(
                        plData.otherIncomeExpense.otherExpenses,
                      ).toLocaleString("en-IN")}
                      )
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between py-3 bg-purple-100 px-3 rounded font-bold text-purple-900">
                    ...
                    >
                      {plData.otherIncomeExpense.netOther >= 0 ? "₹" : "(₹"}
                      {Math.abs(
                        plData.otherIncomeExpense.netOther,
                      ).toLocaleString("en-IN")}
                      {plData.otherIncomeExpense.netOther < 0 && ")"}
                    </span>
                  </div>
            ...
            <div className="pl-6 mb-6">
              <div className="flex justify-between py-2 border-b">
                ...
                <span className="font-semibold text-red-700">
                  ₹{plData.taxExpense.toLocaleString("en-IN")}
                </span>
              </div>
            </div>
            ...
            <div className="flex justify-between py-5 bg-green-600 text-white px-6 rounded-lg font-bold text-xl shadow-lg">
              ...
              <div className="flex gap-8">
                ...
                {showComparison && (
                  <span className="text-sm">
                    ₹{compareData.netProfit.toLocaleString("en-IN")} (
                    {(
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="bg-purple-50 p-4 rounded">
                  ...
                  <p className="text-2xl font-bold text-purple-700">
                    {(
                      (plData.cogs.totalCOGS / plData.revenue.totalRevenue) *
                      100
                    ).toFixed(2)}
                    %
                  </p>
