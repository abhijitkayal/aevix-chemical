...
export default function Packinglist() {
  ...
  const savePacking = async () => {
    await axios.post("https://aevix-chemical-4-9p3j.onrender.com/api/packing-list", form);
    setOpen(false);
    fetchData();
  };

  const fetchData = async () => {
    const res = await axios.get("https://aevix-chemical-4-9p3j.onrender.com/api/packing-list");
    setLists(res.data);
  };
