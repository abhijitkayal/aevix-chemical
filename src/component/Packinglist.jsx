...
export default function Packinglist() {
  ...
  const savePacking = async () => {
    await axios.post("https://aevix-chem-backend-bksy.onrender.com/api/packing-list", form);
    setOpen(false);
    fetchData();
  };

  const fetchData = async () => {
    const res = await axios.get("https://aevix-chem-backend-bksy.onrender.com/api/packing-list");
    setLists(res.data);
  };
