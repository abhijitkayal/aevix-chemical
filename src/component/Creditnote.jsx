...
// const API = "https://aevix-chemical-mpbw.vercel.app/api/credit-notes";
  ...
  const searchInvoice = async (q) => {
    ...
    try {
      ...
      const res = await axios.get(
        `https://aevix-chemical-mpbw.vercel.app/api/invoices/search?q=${q}`
      );
                    ...
                    {invoiceSuggestions.map((inv) => (
                      ...
                      >
                        ...
                        <div className="text-xs text-gray-500">
                          Amount: ₹{inv.totalAmount || 0} | Date: {inv.date ? new Date(inv.date).toLocaleDateString() : 'N/A'}
                        </div>
                      </button>
                    ))}
                  </div>
