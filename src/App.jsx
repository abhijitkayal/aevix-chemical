            ...
            <main className="flex-1 p-6 overflow-y-auto bg-cyan-50 text-black">
              ...
              <Routes>
                ...
                <Route
                  ...
                  element={<SalesTeamPieChart />}
                />
                <Route
                  path="/dashboard/stock-analytics"
                ...
                <Route path="/billing/proforma" element={<Proforma />} />
                <Route
                  path="/billing/delivery-challan"
                  element={<Deliverychalan />}
                />
                ...
                <Route
                  path="/billing/order-acknowledgement"
                  element={<Orderacknowledgement />}
                />
                <Route path="/billing/packing-list" element={<Packinglist />} />
                ...
                {/* Accounting */}
                <Route
                  path="/accounting/inward-payment"
                  element={<Inwardpayment />}
                />
                <Route
                  path="/accounting/outward-payment"
                  element={<Outwardpayment />}
                />
                <Route
                ...
                />
                <Route
                  path="/accounting/payment-reminder"
